...
# declare da fuckaz (remove interactivity for a specific usage scenario)
ssid = "hostpot"
channel = "2"
wpa_passphrase = "atleast#8"
ap_iface = "wlan0"
net_iface = "eth0"
speed_down = "200"
speed_up = "20"
...
#    driftnet_if = input("[?] Capture unencrypted images with DRIFTNET? Y/n: ")
    driftnet_if = "n" #driftnet_if.lower()
    #/DRIFTNET QUESTION
...
#    hostapd_wpa = input("[?] Enable WPA2 encryption? y/N: ")
    hostapd_wpa = "y" #hostapd_wpa.lower()
    if hostapd_wpa == "y":
        canBreak = False
        while not canBreak:
...
#    wireshark_if = input("[?] Start WIRESHARK on " + ap_iface + "? Y/n: ")
    wireshark_if = "y" #wireshark_if.lower()
    tshark_if = "n"
